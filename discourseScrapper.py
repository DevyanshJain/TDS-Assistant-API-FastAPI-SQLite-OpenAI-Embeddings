...
RAW_COOKIE_STRING = "_forum_session=Y9WHWsDvczvuQyssrEXWdguJcE%2B1l3qTb8mtRMdWw8Zr%2FBiqlOL1LMjDgP0hfQFlGiRbbsk4Dg%2BFg5OeAr1s%2BzorZcMXc74TpdyKVhVU3%2Brqhq%2FgZ92ja1dwHY%2BOewu714PzjtD0MjoP9REzjh2NJhojyGvJpT4gD1Od%2FDi4XF7BE9jKrkcairByG2iAMsUQENYOqflfx5s2hnwYATlRVqMGD%2Fc2at2%2BvL3%2FT7TRDcMxk9GKHH%2BDwq%2BHo8pWXD7nHCedgpYsTmfIY1TBNzvBtDjLW4HDZg%3D%3D--HoRHwnqBH7eQzIBa--JVQWLdIFh4gy%2FFJYKaX8dA%3D%3D; _t=9ZhBXjHCSD3Gp6OwJdgUBwsbbVURc87LsM%2BPfgzgptPgHT%2BoD5MXqsnvvZMKRheSeRQY2JcUl79xhy7IrqVI4UsDm4qOAopuWTrTJr3mCFLjnlNARkOjx%2BtGtihVA8BzCbUKSUYJ43DTxVEU1zyWrNv%2Bx0DIfnAqpp84gg75oTJ8dF8H1wC51fyiB2vyGNGqslmBaUAW1Gw%2BGRmkjEVxv7I3wm0z4%2BS8ZcQ9h6Yvho8xU4lNhdVh592CEjByPgynSjG2ntdDBheoKmToGhlskDIpfLlK%2FaQi04RxoXcsUakj5Jo12aGM0PD%2BPrX5O03b--iFVOl9imMFvazpPt--LkveCdS%2FooHlCsdF8SdsRQ%3D%3D"
    ...
    for i, topic_id in enumerate(topic_ids, 1):
        ...
        if topic_json_data:
            ...
            try:
                ...
                base_url = f"{DISCOURSE_BASE_URL}t/{topic_id}"
                ...
                for post in posts:
                    ...
                    # Clean HTML tags (optional: use BeautifulSoup if available)
                    import re
                    ...
                    for i, chunk in enumerate(chunks):
                        cursor.execute("""
                            INSERT INTO discourse_chunks (
                                thread_id, post_id, author, created_at, url, chunk_index, content, embedding
                            ) VALUES (?, ?, ?, ?, ?, ?, ?, NULL)
                        """, (
                            topic_id,
                            post_id,
                ...
                conn.commit()
                conn.close()
                print(f"Inserted {len(posts)} posts for topic {topic_id} into database.")
            except Exception as e:
                print(f"DB insert failed for topic {topic_id}: {e}")
